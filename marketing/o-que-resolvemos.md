...
camadas:
  ...
  - titulo: Conformidade e segurança
    subtitulo: Regularize sua operação sem parar a produção — laudos técnicos,
      inspeção e conformidade normativa.
    tipo: chips
    itens:
...
sobre: "Seção O QUE RESOLVEMOS: 4 camadas (energia, operação, projetos,
