...
#       rotulo: "Veja como verificamos →" ←   o texto do link
#
...
faq:
  ...
  - pergunta: "O que vocês precisam de mim?"
    resposta: "Só o que você já tem: 12 meses de faturas de energia (ou o que tiver), o modelo/ano do equipamento principal e 30 minutos de conversa. Se faltar algum dado, a proposta diz o que ele mudaria na resposta — e quanto custaria obtê-lo."
  ...
  - pergunta: "Vocês atendem à distância?"
    resposta: "Sim — atendimento remoto para todo o Brasil e América do Sul. A análise é feita com os dados disponíveis da planta — faturas, logs e instrumentação existente — sem parar a produção."
