---
# ═══════════════════════════════════════════════════════════════
# SEÇÃO "PARA QUEM" (os setores atendidos)
# ═══════════════════════════════════════════════════════════════
# Para editar:
#   title → título da seção
#   intro → parágrafo abaixo do título
#   setoresPrincipais → os cards grandes (setor + frase)
#   setoresMenores → as "etiquetas" pequenas no fim
#
# MODELO DE CARD (setoresPrincipais):
#   - setor: "Nome do setor"
#     frase: "A frase que aparece no card"
#
# ⚠️ setoresMenores é uma lista entre colchetes [ ] — os itens ficam
#    entre aspas e separados por vírgula.
# ═══════════════════════════════════════════════════════════════
